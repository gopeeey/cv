...
export const backendData: ResumeData = {
  title: "Backend Developer",
  summary:
    "As a backend developer with six years of hands-on experience, I excel in server-side development. Driven by a profound passion for my craft, I remain dedicated to creating scalable and efficient solutions while maintaining clean architecture.",
  work: [
    {
      company: "Turing",
      ...
      description:
        "Trained and fine-tuned LLMs to improve backend code-related task performance.",
      accomplishments: [
        "Trained and fine-tuned LLMs to improve backend code-related task performance.",
    ...
    },
    {
      ...
      accomplishments: [
        "Implemented the backend for a faceted search and navigation feature.",
  ...
  projects: [
    ...
    },
    {
      ...
      shortDescription:
        "A platform that enables businesses to create and manage user wallets via a RESTful API, supporting wallet creation, funding, withdrawals, and transaction tracking.",
      description:
    ...
    //   shortDescription: "Up Or Down. A simple application for monitoring the up or down status of a user's desired sites. It is built entirely in Node.js without third-party libraries (as an added challenge).",
    //   description:
